...
#[inline]
pub fn get_token_iter<'input>(lexer: lexer::Lexer<'input, lexer::Token<'input>>) -> impl Iterator<Item = Spanned<lexer::Token<'input>>> {
...
pub fn token_iter_to_stream<'input>(
    ...
    input: &'input str,
) -> SpannedInput<lexer::Token<'input>, SimpleSpan, Stream<impl Iterator<Item = Spanned<lexer::Token<'input>>>>> {
